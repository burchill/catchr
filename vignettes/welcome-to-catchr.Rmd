...
Particularly useful for when you're working in a different window and waiting for a job to finish / do something unexpected, `catchr` lets you play short sounds whenever conditions are raised.  This functionality requires the [`beepr`](https://CRAN.R-project.org/package=beepr) package, which I've found absolutely worth downloading.
